...
<div id="conteudo">               <!-- Tela de carregamento -->
...
<html lang="pt-br"> 
  <head>
    ...
    <link rel="icon" type="image/png" href="InShot_20240130_110340501.jpg">
  </head>
  <body>
      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-brand" href="?page=default">
              <img style="width: 72px; height: 40px;" src="InShot_20240130_110220251.jpg">
            </a>
            ...
            if(isset($_SESSION['nome'])) { ?>
              ...
              <button class='btn btn-outline-success btn-outline-danger' type=''>
                  <a href='?page=logout' class='button_login'>Sair</a>
              </button>
            <?php } else { ?>
              <button class='btn btn-outline-success botao_login' type=''>
