...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <a class="navbar-brand" href="#">FGS Trip</a>
      ...
      <form class="d-flex" role="search">
        ...
        <button class="btn btn-outline-success botao_login" type="">Login</button>
        <button class="btn btn-outline-success" type="">Cadastro</button>
      </form>
    </div>
  </div>
</nav>
